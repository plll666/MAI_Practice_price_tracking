...
celery_app.conf.update(
    ...
    task_routes={
        "src.celery_work.tasks.parse_url": {"queue": "parsing"},
        "src.celery_work.tasks.parse_product": {"queue": "parsing"},
        "src.celery_work.tasks.parse_user_products": {"queue": "parsing"},
        "src.celery_work.tasks.parse_all_products": {"queue": "parsing"},
        "src.celery_work.tasks.cleanup_old_prices": {"queue": "maintenance"},
        "src.celery_work.tasks.check_price_alerts": {"queue": "notifications"},
        "src.celery_work.tasks.check_price_appeared": {"queue": "notifications"},
    },
    beat_schedule={
        "parse-all-products": {
            "task": "src.celery_work.tasks.parse_all_products",
            "schedule": parse_interval,
            "args": (),
            "options": {"queue": "parsing"},
        },
        "cleanup-old-prices": {
            "task": "src.celery_work.tasks.cleanup_old_prices",
            "schedule": 20000000.0,
            "args": (30,),
            "options": {"queue": "maintenance"},
        },
        "check-price-alerts": {
            "task": "src.celery_work.tasks.check_price_alerts",
            "schedule": 300.0,
            "args": (),
            "options": {"queue": "notifications"},
        },
        "check-price-appeared": {
            "task": "src.celery_work.tasks.check_price_appeared",
            "schedule": 600.0,
            "args": (),
            "options": {"queue": "notifications"},
        },
